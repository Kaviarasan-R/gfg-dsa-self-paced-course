...
class O_TarjanAlgorithm{
    /** STRONGLY CONNECTED COMPONENTS WITH IMPLEMENTATION OF DISCOVERY TIME & LOW VALUE */
    private int V;
    private LinkedList<Integer> adj[];
    private int Time;

    public O_TarjanAlgorithm(int v) {
        V = v;
    ...
    public static void main(String args[]) {
        O_TarjanAlgorithm g = new O_TarjanAlgorithm(5);
